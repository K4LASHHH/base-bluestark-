...
function RageUI.IsVisible(Menu)
...
---@param min number
---@param max number
function RageUI.GenerateList(min, max)
    local list = {}
    for i = min, max do
        list[#list+1] = i
    end
...
function RageUI.DisableControlsOnMenu()
...
---@return Menu
function RageUI.GetCurrentMenu()
    return RageUI.CurrentMenu
end
