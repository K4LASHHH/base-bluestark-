...
local ItemsSlider = {}
for i = 1, 10 do
    table.insert(ItemsSlider, i)
end

function Items:UISliderHeritage(Label, ItemIndex, Description, Actions, Value)
